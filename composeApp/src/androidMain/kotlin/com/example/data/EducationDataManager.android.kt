...
actual object EducationDataManager {
    ...
    actual suspend fun fetchFromFirestore(): List<Stage>? = withContext(Dispatchers.IO) {
    ...
    actual suspend fun saveToFirestore(stages: List<Stage>): Boolean = withContext(Dispatchers.IO) {
